...
private String uv_warning;

private String golf_index;
...
{
return "ClassPojo [snow_code = "+snow_code+", uv_desc = "+uv_desc+", phrase_32char = "+phrase_32char+", day_ind = "+day_ind+", narrative = "+narrative+", alt_daypart_name = "+alt_daypart_name+", accumulation_phrase = "+accumulation_phrase+", snow_range = "+snow_range+", rh = "+rh+", qualifier = "+qualifier+", pop = "+pop+", hi = "+hi+", uv_warning = "+uv_warning+", golf_index = "+golf_index+", pop_phrase = "+pop_phrase+", wdir = "+wdir+", shortcast = "+shortcast+", wind_phrase = "+wind_phrase+", clds = "+clds+", daypart_name = "+daypart_name+", snow_phrase = "+snow_phrase+", fcst_valid = "+fcst_valid+", wdir_cardinal = "+wdir_cardinal+", uv_index_raw = "+uv_index_raw+", snow_qpf = "+snow_qpf+", uv_index = "+uv_index+", icon_code = "+icon_code+", temp_phrase = "+temp_phrase+", fcst_valid_local = "+fcst_valid_local+", subphrase_pt1 = "+subphrase_pt1+", golf_category = "+golf_category+", subphrase_pt2 = "+subphrase_pt2+", wspd = "+wspd+", subphrase_pt3 = "+subphrase_pt3+", vocal_key = "+vocal_key+", wxman = "+wxman+", phrase_12char = "+phrase_12char+", num = "+num+", qualifier_code = "+qualifier_code+", qpf = "+qpf+", long_daypart_name = "+long_daypart_name+", precip_type = "+precip_type+", temp = "+temp+", icon_extd = "+icon_extd+", wc = "+wc+", thunder_enum = "+thunder_enum+", phrase_22char = "+phrase_22char+", thunder_enum_phrase = "+thunder_enum_phrase+"]";
}
}
